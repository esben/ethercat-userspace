/******************************************************************************
 *
 *  $Id: fsm_slave_scan.c,v 7dceb43bd855 2010/09/22 10:28:36 fp $
 *
        ...
        )
{
    ...
    ec_datagram_t *datagram = fsm->datagram;
    ec_slave_mbox_prepare_fetch(fsm->slave, datagram, EC_MBOX_NO_PROTOCOL);
    datagram->mailbox_datagram_type = EC_DATAGRAM_MAILBOX_NONE;  // don't buffer
